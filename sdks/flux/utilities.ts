...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("flux");
			params.setVersion("1.8.3");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2ZsdXhjZC9mbHV4IiwidmVyc2lvbiI6IjEuOC4zIn19"), c => c.charCodeAt(0)));
